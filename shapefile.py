...
Modification Made line 936 
    mhumber, July2013
    Creates a dbf attribute record. Use this function to submit a single
    list of values instead of keyword entries or a sequence of values. Before
    adding records you must add fields for the record values using the
    fields() method. If the record values exceed the number of fields the
    extra ones won't be added.
"""
__version__ = "1.1.7"
...
class Writer:
    ...
    def record(self, *recordList, **recordDict):
        ...
        if recordList:
            print 'field count ', fieldCount, 'record list:  ', recordList
    ...
    def recordFromList(self, recordList):
        """ mhumber, July2013
        Creates a dbf attribute record. Use this function to submit a single
        list of values instead of keyword entries or a sequence of values. Before
        adding records you must add fields for the record values using the
